...
output "spoke1_vnet_id" {
  ...
  value       = module.spoke1.vnet_id
}

output "spoke1_vm_private_ips" {
  description = "Private IPs of VMs in Spoke 1"
  value       = module.spoke1.vm_private_ips
}

output "spoke_n_vnet_id" {
  description = "Spoke N VNet resource ID"
  value       = module.spoke_n.vnet_id
}

output "spoke_n_vm_private_ips" {
  description = "Private IPs of VMs in Spoke N"
  value       = module.spoke_n.vm_private_ips
}
